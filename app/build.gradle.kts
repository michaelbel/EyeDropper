...
android {
    namespace = "org.michaelbel.eyedropper"
    compileSdk = libs.versions.compile.sdk.get().toInt()

    defaultConfig {
        applicationId = "org.michaelbel.eyedropper"
...
base {
    archivesName.set("EyeDropper-v${android.defaultConfig.versionName}(${android.defaultConfig.versionCode})")
}
